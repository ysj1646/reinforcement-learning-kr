...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        PhotoImage = ImageTk.PhotoImage
        up = PhotoImage(Image.open("C:/Users/Student\git/reinforcement-learning-kr/1-grid-world/img/up.png").resize((13, 13)))
        right = PhotoImage(Image.open("C:/Users/Student\git/reinforcement-learning-kr/1-grid-world/img/right.png").resize((13, 13)))
        left = PhotoImage(Image.open("C:/Users/Student\git/reinforcement-learning-kr/1-grid-world/img/left.png").resize((13, 13)))
        down = PhotoImage(Image.open("C:/Users/Student\git/reinforcement-learning-kr/1-grid-world/img/down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open("C:/Users/Student\git/reinforcement-learning-kr/1-grid-world/img/rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open("C:/Users/Student\git/reinforcement-learning-kr/1-grid-world/img/triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open("C:/Users/Student\git/reinforcement-learning-kr/1-grid-world/img/circle.png").resize((65, 65)))
...
class Env:
    ...
    def get_all_states(self):
        return self.all_state
>>>>>>> 785ae35f1b6a37c0ae96c294a4b14add7076735d
